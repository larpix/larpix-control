...
void larpix_config_read_all(larpix_configuration* config,
        larpix_uart_packet packets[LARPIX_NUM_CONFIG_REGISTERS]);
void larpix_config_write_pixel_trim_threshold(larpix_configuration* config,
        larpix_uart_packet* packet, byte channelid);
void larpix_config_read_pixel_trim_threshold(larpix_configuration* config,
        larpix_uart_packet* packet, byte channelid);
void larpix_config_write_global_threshold(larpix_configuration* config,
        larpix_uart_packet* packet);
void larpix_config_read_global_threshold(larpix_configuration* config,
        larpix_uart_packet* packet);
void larpix_config_write_csa_gain_and_bypasses(larpix_configuration* config,
        larpix_uart_packet* packet);
void larpix_config_read_csa_gain_and_bypasses(larpix_configuration* config,
        larpix_uart_packet* packet);
void larpix_config_write_csa_bypass_select(larpix_configuration* config,
        larpix_uart_packet* packet, byte channel_chunk);
void larpix_config_read_csa_bypass_select(larpix_configuration* config,
        larpix_uart_packet* packet, byte channel_chunk);
void larpix_config_write_csa_monitor_select(larpix_configuration* config,
        larpix_uart_packet* packet, byte channel_chunk);
void larpix_config_read_csa_monitor_select(larpix_configuration* config,
        larpix_uart_packet* packet, byte channel_chunk);
void larpix_config_write_csa_testpulse_enable(larpix_configuration* config,
        larpix_uart_packet* packet, byte channel_chunk);
void larpix_config_read_csa_testpulse_enable(larpix_configuration* config,
        larpix_uart_packet* packet, byte channel_chunk);
void larpix_config_write_csa_testpulse_dac_amplitude(larpix_configuration* config,
        larpix_uart_packet* packet);
void larpix_config_read_csa_testpulse_dac_amplitude(larpix_configuration* config,
        larpix_uart_packet* packet);
void larpix_config_write_test_mode_xtrig_reset_diag(larpix_configuration* config,
        larpix_uart_packet* packet);
void larpix_config_read_test_mode_xtrig_reset_diag(larpix_configuration* config,
        larpix_uart_packet* packet);
void larpix_config_write_sample_cycles(larpix_configuration* config,
        larpix_uart_packet* packet);
void larpix_config_read_sample_cycles(larpix_configuration* config,
        larpix_uart_packet* packet);
void larpix_config_write_test_burst_length(larpix_configuration* config,
        larpix_uart_packet* packet, byte value_chunk);
void larpix_config_read_test_burst_length(larpix_configuration* config,
        larpix_uart_packet* packet, byte value_chunk);
void larpix_config_write_adc_burst_length(larpix_configuration* config,
        larpix_uart_packet* packet);
void larpix_config_read_adc_burst_length(larpix_configuration* config,
        larpix_uart_packet* packet);
void larpix_config_write_channel_mask(larpix_configuration* config,
        larpix_uart_packet* packet);
void larpix_config_read_channel_mask(larpix_configuration* config,
        larpix_uart_packet* packet);
void larpix_config_write_external_trigger_mask(larpix_configuration* config,
        larpix_uart_packet* packet);
void larpix_config_read_extenral_trigger_mask(larpix_configuration* config,
        larpix_uart_packet* packet);
void larpix_config_write_reset_cycles(larpix_configuration* config,
        larpix_uart_packet* packet, byte value_chunk);
void larpix_config_read_reset_cycles(larpix_configuration* config,
        larpix_uart_packet* packet, byte value_chunk);
