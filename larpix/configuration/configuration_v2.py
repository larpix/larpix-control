...
_property_configuration = OrderedDict([
        ...
        ('enable_dynamic_reset',
            (_compound_property, (['enable_dynamic_reset', 'enable_min_delta_adc', 'threshold_parity', 'reset_length', 'mark_first_packet'], (int,bool), 0, 1), (1360,1361))),
        ('enable_min_delta_adc',
            (_compound_property, (['enable_dynamic_reset', 'enable_min_delta_adc', 'threshold_parity', 'reset_length', 'mark_first_packet'], (int,bool), 0, 1), (1361,1362))),
        ('threshold_parity',
            (_compound_property, (['enable_dynamic_reset', 'enable_min_delta_adc', 'threshold_parity', 'reset_length', 'mark_first_packet'], (int,bool), 0, 1), (1362,1363))),
        ('reset_length',
            (_compound_property, (['enable_dynamic_reset', 'enable_min_delta_adc', 'threshold_parity', 'reset_length', 'mark_first_packet'], (int,bool), 0, 1), (1363,1366))),
        ('mark_first_packet',
            (_compound_property, (['enable_dynamic_reset', 'enable_min_delta_adc', 'threshold_parity', 'reset_length', 'mark_first_packet'], (int,bool), 0, 1), (1366,1367))),
        ('reset_threshold',
