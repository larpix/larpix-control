...
_property_configuration = OrderedDict([
        ...
        ('enable_tx_dynamic_powerdown',
           (v2_base._compound_property, (['enable_tx_dynamic_powerdown', 'load_config_defaults', 'enable_fifo_diagnostics', 'clk_ctrl', 'enable_external_trigger','enable_external_sync'], (int, bool), 0, 1), (984, 985))),
        ('load_config_defaults',
            (v2_base._compound_property, (['enable_tx_dynamic_powerdown', 'load_config_defaults', 'enable_fifo_diagnostics', 'clk_ctrl', 'enable_external_trigger','enable_external_sync'], (int, bool), 0, 1), (985, 986))),
        ('enable_fifo_diagnostics',
            (v2_base._compound_property, (['enable_tx_dynamic_powerdown', 'load_config_defaults', 'enable_fifo_diagnostics', 'clk_ctrl', 'enable_external_trigger','enable_external_sync'], (int, bool), 0, 1), (986, 987))),
        ('clk_ctrl',
            (v2_base._compound_property, (['enable_tx_dynamic_powerdown', 'load_config_defaults', 'enable_fifo_diagnostics', 'clk_ctrl',  'enable_external_trigger','enable_external_sync'], (int, bool), 0, 3), (987, 989))),
        ('enable_external_trigger',
            (v2_base._compound_property, (['enable_tx_dynamic_powerdown', 'load_config_defaults', 'enable_fifo_diagnostics', 'clk_ctrl', 'enable_external_trigger','enable_external_sync'], (int, bool), 0, 1), (989, 990))),
        ('enable_external_sync',
            (v2_base._compound_property, (['enable_tx_dynamic_powerdown', 'load_config_defaults', 'enable_fifo_diagnostics', 'clk_ctrl', 'enable_external_trigger','enable_external_sync'], (int, bool), 0, 1), (990, 991))),
