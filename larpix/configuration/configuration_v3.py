...
_property_configuration = OrderedDict([
        ...
        ('adc_ibias_delay',
            (v2_base._compound_property, (['adc_ibias_delay','adc_ibias_delay_monitor'], (int,bool), 0, 8), (664,668))),
        ('adc_ibias_delay_monitor',
            (v2_base._compound_property, (['adc_ibias_delay','adc_ibias_delay_monitor'], (int,bool), 0, 4), (668,672))),
        ('csa_bypass_select',
        ...
        ('current_monitor_bank0',
            (v2_base._compound_property, (['current_monitor_bank0','current_monitor_bank1'], (int,bool), 0, 8), (872,876))),
        ('current_monitor_bank1',
            (v2_base._compound_property, (['current_monitor_bank0','current_monitor_bank1'], (int,bool), 0, 8), (876,880))),
        ('current_monitor_bank2',
            (v2_base._compound_property, (['current_monitor_bank2','current_monitor_bank3'], (int,bool), 0, 8), (880,884))),
        ('current_monitor_bank3',
            (v2_base._compound_property, (['current_monitor_bank2','current_monitor_bank3'], (int,bool), 0, 8), (884,888))),
        ('voltage_monitor_bank0',
            (v2_base._compound_property, (['voltage_monitor_bank0','voltage_monitor_bank1'], (int,bool), 0, 8), (888,892))),
        ('voltage_monitor_bank1',
            (v2_base._compound_property, (['voltage_monitor_bank0','voltage_monitor_bank1'], (int,bool), 0, 8), (892,896))),
        ('voltage_monitor_bank2',
            (v2_base._compound_property, (['voltage_monitor_bank2','voltage_monitor_bank3'], (int,bool), 0, 8), (896,900))),
        ('voltage_monitor_bank3',
            (v2_base._compound_property, (['voltage_monitor_bank2','voltage_monitor_bank3'], (int,bool), 0, 8), (900,904))),
