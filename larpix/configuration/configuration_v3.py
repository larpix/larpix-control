...
_property_configuration = OrderedDict([
        ...
        ('voltage_monitor_bank0',
            (v2_base._list_property, ((int,bool), 0, 1, 3, 1), (888,891))),
        ('voltage_monitor_bank1',
            (v2_base._list_property, ((int,bool), 0, 1, 3, 1), (891,894))),
        ('voltage_monitor_bank2',
            (v2_base._list_property, ((int,bool), 0, 1, 3, 1), (896,899))),
        ('voltage_monitor_bank3',
            (v2_base._list_property, ((int,bool), 0, 1, 3, 1), (899,902))),         
        ...
        ('digital_monitor_select',
            (v2_base._compound_property, (['digital_monitor_enable','digital_monitor_select'], (bool, int), 0, 10), (913,917))),
        ('digital_monitor_chan',
            (v2_base._basic_property, (int, 0, 63), (920,926))),
        ('fifo_high_water_lsbs',
            (v2_base._basic_property, (int, 0, 255), (928,936))),
        ('fifo_high_water_msbs',
            (v2_base._basic_property, (int, 0, 7), (936,939))),
        ('total_packets_lsbs',
            (v2_base._basic_property, (int, 0, 255), (944,952))),
        ('total_packets_msbs',
            (v2_base._basic_property, (int, 0, 255), (952,960))),
        ('dropped_packets',
            (v2_base._basic_property, (int, 0, 255), (960,968))),
        ('adc_hold_delay',
            (v2_base._basic_property, (int, 0, 255), (968,976))),
        ('chip_id',
            (v2_base._basic_property, (int, 0, 255), (976,984))),
        ('cds_mode',
            (v2_base._compound_property, (['cds_mode', 'load_config_defaults', 'enable_fifo_diagnostics', 'enable_local_fifo_diagnostics', 'enable_tally', 'enable_external_trigger', 'enable_external_sync', 'gated_reset_mux'], (int, bool), 0, 1), (984,985))),
        ('load_config_defaults',
            (v2_base._compound_property, (['cds_mode', 'load_config_defaults', 'enable_fifo_diagnostics', 'enable_local_fifo_diagnostics', 'enable_tally', 'enable_external_trigger', 'enable_external_sync', 'gated_reset_mux'], (int, bool), 0, 1), (985,986))),
        ('enable_fifo_diagnostics',
            (v2_base._compound_property, (['cds_mode', 'load_config_defaults', 'enable_fifo_diagnostics', 'enable_local_fifo_diagnostics', 'enable_tally', 'enable_external_trigger', 'enable_external_sync', 'gated_reset_mux'], (int, bool), 0, 1), (986,987))),
        ('enable_local_fifo_diagnostics',
            (v2_base._compound_property, (['cds_mode', 'load_config_defaults', 'enable_fifo_diagnostics', 'enable_local_fifo_diagnostics', 'enable_tally', 'enable_external_trigger', 'enable_external_sync', 'gated_reset_mux'], (int, bool), 0, 1), (987,988))),
        ('enable_tally',
            (v2_base._compound_property, (['cds_mode', 'load_config_defaults', 'enable_fifo_diagnostics', 'enable_local_fifo_diagnostics', 'enable_tally', 'enable_external_trigger', 'enable_external_sync', 'gated_reset_mux'], (int, bool), 0, 1), (988,989))),
        ('enable_external_trigger',
            (v2_base._compound_property, (['cds_mode', 'load_config_defaults', 'enable_fifo_diagnostics', 'enable_local_fifo_diagnostics', 'enable_tally', 'enable_external_trigger', 'enable_external_sync', 'gated_reset_mux'], (int, bool), 0, 1), (989,990))),
        ('enable_external_sync',
            (v2_base._compound_property, (['cds_mode', 'load_config_defaults', 'enable_fifo_diagnostics', 'enable_local_fifo_diagnostics', 'enable_tally', 'enable_external_trigger', 'enable_external_sync', 'gated_reset_mux'], (int, bool), 0, 1), (990,991))),        
        ('gated_reset_mux',
            (v2_base._compound_property, (['cds_mode', 'load_config_defaults', 'enable_fifo_diagnostics', 'enable_local_fifo_diagnostics', 'enable_tally', 'enable_external_trigger', 'enable_external_sync', 'gated_reset_mux'], (int, bool), 0, 1), (991,992))),
        ...
        ('i_rx0',
            (v2_base._compound_property, (['i_rx0', 'i_rx1'], int, 0, 3), (1946, 1948))),
        ('i_rx1',
            (v2_base._compound_property, (['i_rx0', 'i_rx1'], int, 0, 3), (1950, 1952))),
        ('i_rx2',
            (v2_base._compound_property, (['i_rx2', 'i_rx3'], int, 0, 3), (1954, 1956))),
        ('i_rx3',
            (v2_base._compound_property, (['i_rx2', 'i_rx3'], int, 0, 3), (1958, 1960))),
        ('i_rx_clk',
            (v2_base._compound_property, (['i_rx_clk', 'i_rx_rst'], int, 0, 3), (1962, 1964))),
        ('i_rx_rst',
            (v2_base._compound_property, (['i_rx_clk', 'i_rx_rst'], int, 0, 3), (1966, 1968))),
        ('i_rx_ext_trig',
