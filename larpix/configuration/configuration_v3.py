...
_property_configuration = OrderedDict([
        ...
        ('adc_comp_trim',
            (v2_base._compound_property, (['ref_current_trim', 'adc_comp_trim'], (int, bool), 0, 31), (653, 656))),
        ('vref_dac',
        ...
        ('en_analog_monitor',
            (v2_base._compound_property, (['en_analog_monitor','reset_threshold_msbs'], (bool, int), 0, 1), (1012,1013))),
        ('reset_threshold_msbs',
            (v2_base._compound_property, (['en_analog_monitor','reset_threshold_msbs'], (bool, int), 0, 1), (1013,1015))),
