from .key import Key
from .configuration import Configuration_v1, Configuration_v2, Configuration_v2b, Configuration_Lightpix_v1, Configuration_v2d, Configuration_v3
from .packet import Packet_v1, Packet_v2, Packet_v3
...
class Chip(object):
    ...
    def get_configuration_packets(self, packet_type, registers=None):
        ...
        elif self.asic_version in (2, 'lightpix-1', '2b', '2d', 3):
